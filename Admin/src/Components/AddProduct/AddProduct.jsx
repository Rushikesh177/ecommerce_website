      ...
      <div className="addproduct-price">
        ...
        <div className="addproduct-itemfield">
          ...
          <select value={productDetails.category} onChange={changeHandler} name="category" className='add-product-selector'>
            <option className='add-product-selector' value="women">Women</option>
            <option className='add-product-selector' value="men">Men</option>
            <option className='add-product-selector' value="kid">Kid</option>
          </select>
